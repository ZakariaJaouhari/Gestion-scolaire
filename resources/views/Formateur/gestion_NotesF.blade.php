...
<body>
    <div class="flex">
        ...
        <div>
            ...
            <h1 class=" font-extrabold relative text-5xl left-72 bottom-44 mb-24"
                style="font-family: 'Apple Chancery';">Les notes</h1>
            <p class="relative left-80 bottom-60 mb-16">Utilisez le filtre pour effectuer une recherche plus rapide.</p>
            <form action="{{ route('filter.notes') }}" method="post"
