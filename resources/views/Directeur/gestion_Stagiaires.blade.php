    ...
    <div class="flex">
        <div class="sidebar fixed">
            <ul class="nav">
                ...
                <li id="logout">
                    <a href="#">
                        <img class="logos" src="" alt="">
                        <img class="logos hv" src="" alt="">Toto</a>
                </li>
            </ul>
        </div>
        <div class="relative left-64">
            ...
            <div class="relative bottom-44">
                <h1 class=" font-extrabold text-5xl ml-10 mb-5" style="font-family: 'Apple Chancery';">Les stagiaires</h1>
                ...
                <a href="{{ route('ajouS') }}">
                    <input
                        ...
                        type="button" value="+ Ajouter stagiaire">
                </a>
                <form method="post" action="{{ route('filtrer_stagiaires') }}">
                    @csrf
                    ...
                    <div class="flex justify-end mb-16 mt-8">
                        <a href="{{ route('stagiaires') }}" class="mr-5 mt-2 font-medium">Réinitialiser</a>
                        <button type="submit"
                            class=" rounded-md  px-3 py-2 text-sm font-semibold text-white shadow-sm  bg-indigo-600 transition ease-in-out delay-10  hover:-translate-y-1 hover:scale-110 duration-300  focus-within:outline-none focus-within:ring-2 focus-within:ring-white focus-within:ring-offset-2 hover:bg-white hover:text-indigo-600">Filtrer</button>
                    </div>

                </form>
                <table class="table relative left-36 min-w-[1200px]">
                    <thead>
                        <tr class="border-b w-80">
                            <th class="relative right-60 ">Nom</th>
                            <th class="relative right-44">Sexe</th>
                            <th class="relative right-40">Date naissance</th>
                            <th class="relative right-36">CIN</th>

                            <th class="relative right-24">Groupe</th>
                        </tr>
                    </thead>
                    <tbody>
                                ...
                                <td class=" ml-10">
                                    <div class="flex items-center">
                                        ...
                                        <div class="relative right-20">
                                            ...
                                            <div class="text-sm opacity-50">{{ $stagiaire->email }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="relative right-36">
                                    {{ $stagiaire->sexe }}
                                </td>
                                <td class="relative right-20">
                                    {{ $stagiaire->date_naissance }}
                                </td>
                                <th class="relative right-36 font-normal">
                                    {{ $stagiaire->CIN }}
                                </th>
                                <th class="relative right-24 font-normal">
                                    {{ $stagiaire->groupe->matricule }}
                                </th>
                                <th class="relative right-5">
                                    <a href="{{ route('stagiaireeditS', $stagiaire->id) }}">
                                        <img src="crayon.png" class="w-6 h-6">
                                    </a>
                                </th>
                                <th>
                                    <a href="/deleteS/{{ $stagiaire->id }}">
                                        <img src="supprimer.png" class="w-6 h-6">
                                    </a>
                                </th>
                                <th>
                                    <a href="/downloadpdf/ {{ $stagiaire->id }}">
                                        <img src="bulletin.png" class="w-8 h-8" alt="">
                                    </a>
                                </th>
                            </tr>
                            <tr>
