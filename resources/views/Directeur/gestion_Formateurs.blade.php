        ...
        <div>
            <div class="relative left-64">
                ...
                <div class="relative bottom-44">
                    <h1 class=" font-extrabold text-5xl ml-10 mb-5" style="font-family: 'Apple Chancery';">Les formateurs</h1>
                    ...
                    <a href="{{ route('ajouF') }}">
                        <input
                            ...
                            type="button" value="+ Ajouter formateur">
                    </a>
                    <form method="post" action="{{ route('filtrer_formateurs') }}">
                        @csrf
                        ...
                        <div class="flex justify-end mb-16 mt-8">
                            <a href="{{ route('formateurs') }}" class="mr-5 mt-2 font-medium">Réinitialiser</a>
                            <button type="submit"
                    ...
                    <table class="table relative left-36 min-w-[1200px]">
                        <thead>
                            <tr class="border-b w-80">
                                ...
                                <th class="relative right-36">Matricule</th>
                                <th class="relative right-28">Sexe</th>
                                <th class="relative right-24">Date naissance</th>
                                <th class="relative right-24 ">Situation familiale</th>
                                <th class="relative right-24">Date recrutement</th>
                                        ...
                                        <div class="flex items-center gap-3">
                                            <div>
                                                <div class="mask mask-squircle  relative right-24">
                                                    <img src="{{ asset($formateur->profile_picture) }}"
                                                        class=" w-20 h-20 rounded-full border" />
                                                </div>
                                            </div>
                                            <div class="relative right-20">
                                                <div class="font-bold">{{ $formateur->prenom }} {{ $formateur->nom }}
                                                </div>
                                                <div class="text-sm opacity-50">{{ $formateur->email }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="relative right-28">
                                        {{ $formateur->matricule }}
                                    </td>
                                    <td class="relative right-24">
                                        {{ $formateur->sexe }}
                                    </td>
