...
<body>
    <div class="flex">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="{{ route('formateurs') }}" class="active">
                        <img class="logos formateur hidden" src="{{ asset('prof.png') }}" alt="" />
                        <img class="logos formateur hv block" src="{{ asset('prof-hover.png') }}" alt="" />
                        Formateurs</a>
                </li>
                <li>
        ...
        <div>
            ...
            <h1 class=" font-extrabold relative text-5xl left-72 bottom-44 mb-12" style="font-family: 'Apple Chancery';">Modifier formateur</h1>
            <form id="form" class=" bottom-64 ml-96 left-28 relative  min-w-[950px]  rounded-3xl"
                action="{{ route('formateur.update', $formateur) }}" enctype="multipart/form-data" method="POST"><br>
                @csrf
                @method('PUT')
                        ...
                        <div class="flex-col mt-10 space-y-8">
                            <div class="flex space-x-4">
                                <div class="relative h-11 w-full min-w-[400px]">
                                    <input id="nom" name="nom" oninput="generateEmail();generatepassword()"
                                ...
                                <div class="relative h-11 w-full  min-w-[400px]">
                                    <input id="prenom" name="prenom" oninput="generateEmail()"
                                    ...
                                    <div class="sm:col-span-3">
                                        <div class="relative h-11 w-full min-w-[400px]">
                                            <select id="sexe" name="sexe"
                                                ...
                                                <option value=""></option>
                                                <option value="Homme"
                                                    {{ old('sexe', $formateur->sexe) == 'Homme' ? 'selected' : '' }}>
                                                    Homme</option>
                                                <option value="Femme"
                                                    {{ old('sexe', $formateur->sexe) == 'Femme' ? 'selected' : '' }}>
                                                    Femme</option>
                                            </select>
                                        </div>
                                    </div>
