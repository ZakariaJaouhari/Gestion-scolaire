            ...
            <div class="relative bottom-44">
                ...
                <a href="{{ route('ajouM') }}">
                    <input
                        ...
                        type="button" value="+ Ajouter module">
                </a>
                <form method="post" action="{{ route('filtrer_modules') }}">
                    @csrf
                    ...
                    <div class="flex justify-end mb-16 mt-8">
                        <a href="{{ route('modules') }}" class="mr-5 mt-2 font-medium">Réinitialiser</a>
                        <button type="submit"
                ...
                <table class="relative left-36 min-w-[1200px] w-auto">
                    <thead>
                        <tr class="border-b ">
                            ...
                            <th class="relative ">Matricule</th>
                            <th class="relative ">Date début</th>
                            <th class="relative ">Date fin</th>
                            <th class="relative ">Heures présentiel</th>
                            <th class="relative">Formateur</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($modules as $module)
                            <tr class=" h-10">
                                <td class="relative text-sm opacity-50">
                                    {{ $module->nom }}
                                </td>
